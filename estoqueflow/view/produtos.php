...
if(isset($_SESSION['usuario'])){
    ...
    <div class="col-sm-12">
        <div class="row">
            <form id="frmRelatorioEstoqueDatas" action="../procedimentos/produtos/criarRelatorioEstoqueDataPdf.php" method="POST" target="_blank">
                <div class="col-sm-3">
                    <label>Início (Cadastro)</label>
                    <input type="date" name="dataInicio" class="form-control input-sm" required>
                </div>
                <div class="col-sm-3">
                    <label>Fim (Cadastro)</label>
                    <input type="date" name="dataFim" class="form-control input-sm" required>
                </div>
                <div class="col-sm-3">
                    <p></p>
                    <button class="btn btn-primary btn-sm">
                        Estoque por Período <span class="glyphicon glyphicon-calendar"></span>
                    </button>
                </div>
            </form>
            ...
            <div class="col-sm-3">
                <p></p>
               <a href="../procedimentos/produtos/criarRelatorioEstoquePdf.php" target="_blank" class="btn btn-success btn-sm">
    Estoque Geral Completo <span class="glyphicon glyphicon-list-alt"></span>
</a>
            </div>
        </div>
    </div>
