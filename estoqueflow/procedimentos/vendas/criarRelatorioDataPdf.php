...
// IMPORTANTE: Verifique se a pasta no htdocs é 'sistema'.
$url = "http://localhost/estoqueflow/view/vendas/relatorioVendasDataPdf.php?inicio=$dataInicio&fim=$dataFim";
